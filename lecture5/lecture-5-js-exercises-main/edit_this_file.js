...
*/
const fruitListItems = document.querySelectorAll('#fruit-list *')
 ...
 */
 const fruitWithoutA = fruits.filter(fruit => !(fruit.includes('a') || fruit.includes('A')) );
...
document.querySelector('#destination').appendChild(travelElement);
